...
/**
 * POST /api/vanity/mark-used
 * Marks a vanity mint as used after successful on-chain token creation.
 */
export async function POST(request: Request) {
  try {
    ...
    console.error("[vanity/mark-used] Exception:", e);
